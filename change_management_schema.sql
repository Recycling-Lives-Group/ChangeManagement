...
--
-- Table structure for table `benefit_scoring_config`
--

DROP TABLE IF EXISTS `benefit_scoring_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `benefit_scoring_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `benefit_type` varchar(50) NOT NULL,
  `display_name` varchar(100) NOT NULL,
  `value_for_100_points` decimal(15,2) NOT NULL,
  `value_unit` varchar(20) DEFAULT 'GBP',
  `time_decay_per_month` int(11) NOT NULL,
...
CREATE TABLE `change_requests` (
  ...
  `effort_factors` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Individual effort factor scores: impactScope, businessCritical, complexity, testingCoverage, rollbackCapability, historicalFailures, costToImplement, timeToImplement' CHECK (json_valid(`effort_factors`)),
  `benefit_factors` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Individual benefit factor scores: revenueImprovement, costSavings, customerImpact, processImprovement, internalQoL, urgency, impactScope, riskLevel, resourceRequirement, strategicAlignment' CHECK (json_valid(`benefit_factors`)),
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `diagram_state`
--

DROP TABLE IF EXISTS `diagram_state`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `effort_scoring_config`
--

DROP TABLE IF EXISTS `effort_scoring_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `effort_scoring_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `effort_type` varchar(50) NOT NULL,
  `display_name` varchar(100) NOT NULL,
  `value_for_100_points` decimal(15,2) NOT NULL,
  `value_unit` varchar(20) DEFAULT 'hours',
  `time_decay_per_month` int(11) NOT NULL,
  `description` text DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT 1,
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `effort_type` (`effort_type`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-03 14:47:56
